export default function Footer () {
    return (
        <div className="blockcode bg-light">
            <footer className="page-footer shadow">
                <div className="d-flex flex-column mx-auto py-5" style={{width: '80%'}}>
                <div className="d-flex flex-wrap justify-content-between">
                    <div>
                    <a href="/" className="d-flex align-items-center p-0 text-dark">
                        <span className="ms-3 h5 font-weight-bold">SecureBuy</span>
                    </a>
                    <p className="my-3" style={{width: '250px'}}>
                    We Are Committed To Providing Our Customers With The Highest Level Of Security And Trust In Their Online Shopping Experience.
                    </p>
                    <span className="m-4">
                    ...
                    <div>
                    <p className="h5 mb-4" style={{fontWeight: 600}}>SecureBuy</p>
                ...
                <small className="text-center mt-5">&copy; SecureBuy, 2023. All rights reserved.</small>
            </div>
            </footer>
        </div>
    )
